    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="fixed-table-toolbar">
            ...
            <div class="columns columns-right btn-group float-right">
              <button class="btn btn-secondary" type="button" name="paginationSwitch" aria-label="Hide/Show pagination" title="Hide/Show pagination"><i class="fa fa-caret-square-down"></i> </button>
              <button class="btn btn-secondary" type="button" name="refresh" aria-label="Refresh" title="Refresh"><i class="fa fa-sync"></i> </button>
              <button class="btn btn-secondary" type="button" name="toggle" aria-label="Show card view" title="Show card view"><i class="fa fa-toggle-off"></i> </button>
              <button class="btn btn-secondary" type="button" name="fullscreen" aria-label="Fullscreen" title="Fullscreen"><i class="fa fa-arrows-alt"></i> </button>
              <div class="keep-open btn-group" title="Columns">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="">
                  ...
                  <label class="dropdown-item dropdown-item-marker"><input type="checkbox" data-field="name" value="2" checked="checked">
                    <span>language</span>
                  </label>
                  <label class="dropdown-item dropdown-item-marker">
                  ...
                  <label class="dropdown-item dropdown-item-marker">
                    <input type="checkbox" data-field="operate" value="4" checked="checked">
        ...
        <div class="panel-body container col-md-12" style="text-align: left; ">
            ...
            <a role="link" class="btn btn-default"  href="/manage/category/add/" >
          ...
          <thead>
            <tr>
              <th class="bs-checkbox " style="text-align: center; vertical-align: middle; width: 36px; " rowspan="2" data-field="state">
                <div class="th-inner ">
                  <label>
                    <input name="btSelectAll" type="checkbox" class="">
                    <span></span>
                  </label>
                </div>
              ...
              <th colspan="3" style="text-alin: center;">Operations</th>
            </tr>
          </thead>
          <tbody>
            ...
            @foreach ($categories as $category)
              <tr role="row">
                <td class="bs-checkbox" style="text-align: center; vertical-align: middle; width:36px; ">
                  <label>
                    <input data-index="{{ $category->id }}" name="btSelectItem" type="checkbox" value="{{ $category->id }}">
                    <span></span>
                  </label>
                </td>
                ...
                <td style="text-align=center; width:auto;">
                  <a class="btn btn-primary border" href="/manage/categoru/{{ $category->id }}/">
                ...
                <td style="text-align: center; width:auto;">
                                        <!-- <a class="btn btn-primary  border" role="button" href="/category/{{ $category->id }}/edit/"><i class="fa fa-edit white"></i> Edit </a> -->
                                        ...
                                        <a href="#" class="btn btn-xs btn-primary edit" id="'.$student->id.'"><i class="glyphicon glyphicon-edit"></i> Edit</a>

                                </td>
                                <td style="text-align: center; width:auto;">
                                    <!-- <a href ="/category/{{ $category->id }}/delete/" class="btn btn-danger"><i class="fa fa-times white"></i> Delete </a> -->
                                    ...
                                    @if ($category->trashed())
                                      <a onclick="return confirm('Are you sure, you want to restore?')" href="/manage/category/{{ $category->id }}/restore" class="btn btn-xs btn-danger delete" id="{{ $category->id }}"><i class="glyphicon glyphicon-remove" value="delete"></i> Restore</a>
                                    @else
                                      <a onclick="return confirm('Are you sure you want to delete?')" href="/manage/category/{{ $category->id }}/delete" class="btn btn-xs btn-danger delete" id="{{ $category->id }}"><i class="glyphicon glyphicon-remove" value="delete"></i> Delete</a>
                                    @endif
                                </td>
            ...
            <!-- {{ $categories->links() }} -->
            {{ $categories->appends(['sort' => 'title'])->links() }}
          </tbody>
        </table>
        </div>
      <!-- </div>
