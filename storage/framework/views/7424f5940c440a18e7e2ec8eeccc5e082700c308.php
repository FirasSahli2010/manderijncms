...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'شركة أكديما لصناعة الأدوية البيطرية :: أكبيطرة')); ?></title>
    ...
    <body class="<?php echo e($class ?? ''); ?>" style="background-color: #000;">
...
<?php /**PATH C:\laragon\www\acdivet\resources\views/layouts/app.blade.php ENDPATH**/ ?>