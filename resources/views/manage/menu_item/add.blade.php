...
<!-- <div class="container">
  <div class="row justify-content-center"> -->
    <!-- <div class="col-md-12">--><div class="well">
      ...
      <form method="POST" action="/manage/menu/{$menu->id}/item" class="form-horizontal">
        @csrf
     ...
     <!--  <div class="col-lg-4"> -->
            ...
            <div class="form-group">
              <div >
                ...
                <input type="text" placeholder="Lnik" id="link" name="link" class=" form-control {{ $errors->has('link') ? 'error' : '' }}" />
              </div>
