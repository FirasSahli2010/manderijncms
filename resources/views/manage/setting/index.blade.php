...
<div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading main-color-bg">
            <h3 class="panel-title">{{ __('Website Settings') }}</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-12 table-responsive" >
        ...
        <form method="POST"  action="/manage/setting/update" class="form-horizontal" enctype="multipart/form-data">
          @csrf
          @method('PUT')
              ...
              <div class="col-lg-12" >
                ...
                <!-- </div> -->
                  <div class="input-group">
                    <input type="number" id="title_size" name="title_size" class=" form-control" value="{{ $settingObject->titleSize }}" />
