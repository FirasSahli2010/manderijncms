    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-12">
        ...
        <div class="panel-body container col-md-12" style="text-align: left; ">
            ...
            <a role="link" class="btn btn-primary"  href="/manage/language/add/" >
          ...
          <tbody>
            ...
            @foreach ($languages as $language)
              <tr id="tr_{{ $language->id }}" role="row">
                ...
                <td>
                  @if ($language->shw  == 'Y')
                    <button style="background-color: #00913B;" type="button" title="Disable" class="btn btn-success" onclick="window.location.replace('/manage/language/{{ $language->id }}/disable')">
                                Enabled
                  ...
                  @else
                    <button type="button" title="Enable" class="btn btn-outline-danger" onclick="window.location.replace('/manage/language/{{ $language->id }}/enable')">
                ...
                <td>
                  ...
                  @else
                    @if($language->shw == 'Y')
                      <button style="background-color: #transparent;" type="button" title="set Default" class="btn btn-link" onclick="window.location.replace('/manage/language/{{ $language->id }}/set_default')">
                ...
                <td style="text-align: center; width:auto;">
                                        ...
                                        <a href="/manage/language/{{ $language->id }}/edit/"
                                            @if ($language->shw == 'N')
