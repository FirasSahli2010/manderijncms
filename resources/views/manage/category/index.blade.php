          ...
          <tbody>
            ...
            @foreach ($categories as $category)
              <tr id="tr_{{ $category->id }}" role="row">
                ...
                <td>
                  @if ($category->shw  == 'Y')
                    <button style="background-color: #00913B;" type="button" title="Draft" class="btn btn-success" onclick="window.location.replace('/manage/category/{{ $category->id }}/disable')"
                      @if ($category->trashed())
                  ...
                  @else
                    <button type="button" title="Enable" class="btn btn-outline-danger" onclick="window.location.replace('/manage/category/{{ $category->id }}/enable')"
                      @if ($category->trashed())
                        class="form-control" disabled
                      @else
                        class="btn btn-xs btn-primary edit"
                ...
                <td style="text-align=center; width:auto;">
                  ...
                  @else
                    class="btn btn-xs btn-primary edit"
                  @endif href="/manage/category/{{ $category->id }}/">
                ...
                <td style="text-align: center; width:auto;">
                                        ...
                                        <a href="/manage/category/{{ $category->id }}/edit/"
                                            @if ($category->trashed())
                                              class="form-control" disabled
                                            @else
                                              class="btn btn-xs btn-primary edit"
                                ...
                                <td style="text-align: center; width:auto;">
                                    ...
                                    @if ($category->trashed())
                                      <a onclick="return confirm('Are you sure, you want to restore?')" href="/manage/category/{{ $category->id }}/restore" class="btn btn-success" id="{{ $category->id }}">
                                    ...
                                    @else
                                      <a onclick="return confirm('Are you sure you want to delete?')" href="/manage/category/{{ $category->id }}/delete" class="btn btn-xs btn-danger delete" id="{{ $category->id }}">
                                ...
                                <td style="text-align: center; width:auto;">
                                    ...
                                    <!-- <a href ="/category/{{ $category->id }}/delete/" class="btn btn-danger">
                                      ...
                                      <a onclick="return confirm('Are you sure you want to destroy this item, this operation can not be reverted?')" href="/manage/category/{{ $category->id }}/permdelete" class="btn btn-xs btn-danger" id="{{ $category->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                          <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                          <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                        </svg>
