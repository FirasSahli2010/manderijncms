...
<!-- <div class="container">
  <div class="row justify-content-center"> -->
    <!-- <div class="col-md-12">--><div class="well">
      ...
      <form method="POST"  action="/admin/post/{{ $post->id }}" class="form-horizontal">
        @csrf
        @method('PUT')
        <fieldset class="uk-fieldset">
          <div class="laraberg-sidebar">
            <div class="form-group">
              ...
              <div >
                <input type="text" id="title" name="title" value="{{ $post->title }}" class="form-control {{ $errors->has('title') ? 'error' : '' }}" />
          ...
          <div class="form-group">
            <div class="uk-margin">
                <!-- <input type="text" class="uk-input uk-form-large laraberg-sidebar {{ $errors->get('title') ? 'uk-form-danger' : '' }}" name="title_sub" placeholder="Title" value="{{ $post->title }}"> -->
                <textarea id="post-title-0" class="editor-post-title__input" placeholder="Add title" rows="1" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 95px;">{{ $post->title }}</textarea>
            </div>
            <div class="uk-margin">
              <textarea style="width: 100%" name="desc" id="desc" placeholder="Add desctiption" hidden="">{{ $post->lb_raw_content }}</textarea>
            </div>
          </div>
        </fieldset>
