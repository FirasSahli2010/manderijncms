<header id="header" class="shadow-xs">
  ...
  <div class="container-fluid position-relative">
    <nav class="navbar navbar-expand-lg navbar-light justify-content-lg-between justify-content-md-inherit navbar-top navbar-expand-md navbar-dark"  id="navbar-main">
      <div class="align-items-start">
            ...
            <a class="navbar-brand d-inline-block d-lg-none" href="index.html">
                <img src="{{ asset('assets') }}/img/brand/logo/logo_dark.svg" width="110" height="70" alt="find the logo">
            </a>
        ...
        <div class="collapse navbar-collapse" id="navbarMainNav">
            ...
            <div class="navbar-xs d-none">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('assets') }}/img/brand/logo/logo_dark.svg" width="110" height="70" alt="Logo is not foiund">
                </a>
            ...
            <ul class="navbar-nav align-items-center navbar-nav d-none d-md-flex">
        ...
        <ul class="list-inline list-unstyled mb-0 d-flex align-items-end">
                ...
                <div aria-labelledby="dropdownMessageOptions" class="dropdown-menu dropdown-menu-clean dropdown-menu-navbar-autopos dropdown-menu-invert dropdown-click-ignore p-0 mt--18 fs--15 w--300">
                    ...
                    <div class="max-h-50vh scrollable-vertical">
                        ...
                        <a href="#!" class="clearfix dropdown-item font-weight-medium px-3 border-bottom border-light overflow-hidden shadow-md-hover bg-theme-color-light">
                            ...
                            <!-- image -->
                            <div class="w--50 h--50 mb-2 mt-1 rounded-circle bg-cover bg-light float-start" style="background-image:url('{% static "assets/images/icons/user80.png" %}')"></div>
                        ...
                        <a href="#!" class="clearfix dropdown-item font-weight-medium px-3 border-bottom border-light overflow-hidden shadow-md-hover">
                            ...
                            <!-- image -->
                            <div class="w--50 h--50 mb-2 mt-1 rounded-circle bg-cover bg-light float-start" style="background-image:url('{% static "assets/images/unsplash/team/michael-dam-mEZ3PoFGs_k-unsplash.jpg" %}')"></div>
                        ...
                        <a href="#!" class="clearfix dropdown-item font-weight-medium px-3 border-bottom border-light overflow-hidden shadow-md-hover">
                            ...
                            <!-- image -->
                            <div class="w--50 h--50 mb-2 mt-1 rounded-circle bg-cover bg-light float-start" style="background-image:url('{% static "assets/images/unsplash/team/joseph-gonzalez-iFgRcqHznqg-unsplash.jpg" %}')"></div>
                        ...
                        <a href="#!" class="clearfix dropdown-item font-weight-medium px-3 border-bottom border-light overflow-hidden shadow-md-hover">
                            ...
                            <!-- image -->
                            <div class="w--50 h--50 mb-2 mt-1 rounded-circle bg-cover bg-light float-start" style="background-image:url('{% static "assets/images/unsplash/team/erik-mclean-06vpBIHmiYc-unsplash.jpg" %}')"></div>
                        ...
                        <a href="#!" class="clearfix dropdown-item font-weight-medium px-3 border-bottom border-light overflow-hidden shadow-md-hover">
                            ...
                            <!-- image -->
                            <div class="w--50 h--50 mb-2 mt-1 rounded-circle bg-cover bg-light float-start" style='background-image:url("{{ asset('assets') }}/img/brand/unsplash/team/valerie-elash-9IL_stSpvOU-unsplash.jpg")'></div>
            ...
            <li class="list-inline-item ml--6 mr--6 dropdown">
              <a class="btn btn-sm btn-light dropdown-toggle btn-pill pl--12 pr--12 nav-link pr-0" id="dropdownAccountOptions" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                      <span class="group-icon m-0 fs--14 d-none d-sm-inline-block font-weight-medium">
                ...
                <div aria-labelledby="dropdownAccountOptions" class="prefix-link-icon prefix-icon-dot dropdown-menu dropdown-menu-clean dropdown-menu-navbar-autopos dropdown-menu-invert dropdown-click-ignore p-0 mt--18 fs--15 w--300">
                    ...
                    <div class="dropdown-header fs--14 py-4">
                        ...
                        <!-- profile image -->
                        <div class="w--60 h--60 rounded-circle bg-light bg-cover float-start" style='background-image:url(" {{ asset('assets') }}/img/brand/icons/user80.png")'></div>
