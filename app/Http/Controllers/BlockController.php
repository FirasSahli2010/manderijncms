...
class BlockController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index()
    {
      ...
      return view('manage.block.index',compact('blocks'));
    }
    ...
    public function create()
    {
        ...
        return view('manage.block.add',compact('category_data', 'page_data', 'post_data', 'template_date', 'langArray'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/manage/block/')->with('message', 'Record created!');
    ...
    public function edit($id)
    {
      ...
      return view('manage.block.edit',compact('block', 'category_data', 'page_data', 'page_data', 'post_data', 'template_date',  'langArray'));
    }
    ...
    public function destroy($id)
    {
      ...
      if ($result) {
            ...
            return redirect('/manage/block/')->with('message', 'Record deleted!');
        } else {

            return redirect('/manage/block/')->with('message', 'Delete failed!');
        }
    }
    ...
    public function enable($id)
    {
      ...
      $block->save();
      return redirect('manage/block')->with('message', 'Block enabled!');
    }
    ...
    public function disable($id)
    {
      ...
      $block->save();
      return redirect('manage/block')->with('message', 'Block disabled!');
    }
    ...
    public function deleteAll(Request $request)
    {
        ...
        foreach ($id_array as $id) {
          ...
          if (!$result) {
            return redirect('/manage/block/')->with('message','Not all records deleted!');
          }
        }
        // $result = Categories::whereIn('id',explode(",",$ids))->delete();
        return redirect('/manage/block/')->with('message','Records deleted!');
    }
}
