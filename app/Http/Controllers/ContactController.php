...
class ContactController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index()
    {
      ...
      return view('manage.contacts.index',compact('contacts'));
    }
    ...
    public function create()
    {
      ...
      return view('manage.contacts.add',compact('langArray'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $contact->save();
      return redirect('/manage/contact')->with('success', 'Contact saved!');
    }
    ...
    public function show($id)
    {
      ...
      return view('manage.contacts.detail',compact('contact', 'langArray'));
    }
    ...
    public function edit($id)
    {
      ...
      return view('manage.contacts.edit',compact('contact', 'langArray'));
    }
    ...
    public function destroy($id)
    {
      ...
      if ($result) {
            ...
            return redirect('/manage/contact/')->with('message', 'Record deleted!');
        } else {

            return redirect('/manage/contact/')->with('message', 'Delete failed!');
        }
    ...
    public function deleteAll(Request $request)
    {
        ...
        foreach ($id_array as $id) {
          ...
          if (!$result) {
            return redirect('/manage/contact/')->with('message','Not all records deleted!');
          }
        }
        // $result = Categories::whereIn('id',explode(",",$ids))->delete();
        return redirect('/manage/contact/')->with('message','Records deleted!');
    }
}
