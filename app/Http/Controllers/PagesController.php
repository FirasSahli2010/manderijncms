...
class PagesController extends Controller
{
  public function __construct() {
    ...
    public function enable($id)
    {
      ...
      $page->save();
      return redirect('manage/page')->with('message', 'Page published!');
    }
    ...
    public function permdelete($id) {
      ...
      if ($result) {
            ...
            return redirect('/manage/page/')->with('message', 'page deleted!');
        } else {

            return redirect('/manage/page/')->with('message', 'page failed!');
        }
        ...
        if (!is_null($page)) {
          ...
          $page->save();
            ...
            // return view('manage.category.detail', ['category' => Categories::findOrFail($id)]);
              return redirect('/manage/page/')->with('message', 'Record restored!');
        } else {

            return redirect('/manage/page/')->with('message', 'Restore failed!');
        }
        return response($response);
    }
    ...
    public function add()
    {
      ...
      return view('manage.page.add',compact('data', 'langArray'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $page->save();
      return redirect('/manage/page/')->with('message', 'Record created!');
    }
    ...
    public function show($id)
    {
        ...
        return view('manage.page.detail',compact('page'));
    }
    ...
    public function edit($id)
    {
      ...
      return view('manage.page.edit',compact('page', 'data', 'langArray'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $page->save();
      return redirect('/manage/page/')->with('message', 'Record updated!');
    }
    ...
    public function destroy(Pages $pages)
    {
      ...
      if ($result) {
            ...
            // return view('manage.category.index',compact('categories'));
            return redirect('/manage/page/')->with('message', 'Record deleted!');
        } else {

            return redirect('/manage/page/')->with('message', 'Delete failed!');
        }
    ...
    public function deleteAll(Request $request)
    {
        ...
        foreach ($id_array as $id) {
          ...
          if (!$result) {
            return redirect('/manage/page/')->with('message','Not all records deleted!');
          }
        }
