...
class ProductController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function create()
    {
      ...
      return view('manage.product.add',compact('data', 'langArray'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $product->save();
      return redirect('/manage/products/')->with('message', 'Record created!');
    }
    ...
    public function edit($id)
    {
      ...
      return view('manage.product.edit',compact('product', 'data', 'langArray', 'cat_ids'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $product->save();
      return redirect('/manage/products')->with('message', 'Product Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($result) {
              ...
              return redirect('/manage/products/')->with('message', 'Record deleted!');
          } else {

              return redirect('/manage/products/')->with('message', 'Delete failed!');
          }
    }
    ...
    public function enable($id)
    {
      ...
      $product->save();
      return redirect('manage/products')->with('message', 'Product published!');
    }
    ...
    public function disable($id)
    {
      ...
      $product->save();
      return redirect('manage/products')->with('message', 'Product un-published!');
    }
    ...
    public function deleteAll(Request $request)
    {
        ...
        foreach ($id_array as $id) {
          ...
          if (!$result) {
            return redirect('/manage/products/')->with('message','Not all records deleted!');
          }
        }
        // $result = Categories::whereIn('id',explode(",",$ids))->delete();
        return redirect('/manage/products/')->with('message','Records deleted!');
    }
}
