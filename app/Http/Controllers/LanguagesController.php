...
class LanguagesController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
      if(!$request['_method']) {
        ...
        $language->save();
        return redirect('manage/language')->with('message', 'Record created!');
      }
      else {
        ...
        $language->save();
        return redirect('manage/language')->with('message', 'Record updated!');
      }
    }
    ...
    static function get_language_name($id) {
        $language = Languages::where('id', $id)->where('shw','Y')->select('name')->first();
